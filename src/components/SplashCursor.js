...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Prefer site accent color when available
    const cssAccent = getComputedStyle(document.documentElement)
      .getPropertyValue("--accent")
      .trim();
    const initialColor = cssAccent || COLOR;
   ...
   `;
    ...
    function resizeDoubleFBO(
      ...
      target.read = resizeFBO(
        target.read, w, h, internalFormat, format, type, param,
      );
    ...
    // Event handlers as named functions so they can be removed
