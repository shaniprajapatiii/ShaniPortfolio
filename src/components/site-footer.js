         ...
         <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-3 lg:px-8">
            <div>
               ...
               <p className="mt-3 max-w-xs text-sm text-muted-foreground">
                  Software engineer building products at the intersection of
                  algorithms, AI and the web.
               </p>
            </div>
               ...
               <div className="mt-3 grid grid-cols-2 gap-y-1.5 text-sm">
                  {NAV.map((item) => (
                     <Link
                        key={item.href}
                        href={item.href}
                        className="text-foreground/80 hover:text-ember"
                     >
                        {item.label}
                     </Link>
                  ))}
            ...
            <div>
               ...
               <div className="mt-3 flex flex-col gap-2 text-sm">
                  <a
                     ...
                     className="inline-flex items-center gap-2 text-foreground/80 hover:text-ember"
                  >
